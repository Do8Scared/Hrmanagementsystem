...
export function MyProfile() {
  ...
  const [personal, setPersonal] = useState({
    name: '', birthDate: '1995-05-15', gender: 'Male',
  ...
  if (loading) {
    return <div className="p-8 text-[#6B7280]">Loading profile...</div>;
  }

  if (!emp) {
    return <div className="p-8 text-[#6B7280]">Profile not found.</div>;
  }
